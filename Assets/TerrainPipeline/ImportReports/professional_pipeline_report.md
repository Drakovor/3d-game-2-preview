...
| Blender | Ready | Blockout, layout assembly, kitbash/reference modular meshes, and manual cleanup where needed. | `Tools/FantasyWorldPipeline/blender` | 100 Blender reference FBX file(s) found. These are blockout/reference meshes, not a replacement for Houdini/ZBrush/Substance passes. |
...
- Mesh streaming: 69 stream cell(s), 69 LODGroup(s), 0 Houdini chunk cell(s), 5 CC0 kitbash cell(s), 64 Blender/reference cell(s).
